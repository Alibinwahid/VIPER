  ...
  , m_trackingOn()
{
  ...
  m_imageSub = n.subscribe<sensor_msgs::Image>("/viper/left/image_rect", 1, &FollowMeWindow::leftimageCb, this);
  m_statusSub = n.subscribe<std_msgs::String>("/viper/follow_me/status", 1, &FollowMeWindow::statusCb, this);
  m_boundingBoxesSub = n.subscribe<cvm_msgs::BoundingBoxes>("/viper/follow_me/bounding_boxes", 1, &FollowMeWindow::boundingBoxesCb, this);
  m_targetBoundingBoxSub = n.subscribe<cvm_msgs::BoundingBox>("/viper/follow_me/target_bounding_box", 1, &FollowMeWindow::targetBoxCb, this);
  m_targetPositionSub = n.subscribe<geometry_msgs::Point>("/viper/follow_me/target_position", 1, &FollowMeWindow::targetPositionCb, this);
  m_dynParametersSub = n.subscribe<dynamic_reconfigure::Config>("/viper/cvm_follow_me/parameter_updates", 1,&FollowMeWindow::parameterUpdates, this);
  // Initialize publishers
  m_enablePub = n.advertise<std_msgs::Bool>("/viper/follow_me/enable", 1);
  m_setTargetPub = n.advertise<cvm_msgs::BoundingBox>("/viper/follow_me/set_target", 1);
}
...
void FollowMeWindow::changeDoubleParameter(const std::string& name, double value)
{
  ...
  ros::service::call("/viper/cvm_follow_me/set_parameters", serverRequest, serverResponse);
}
